...
class ReportGeneratorState(TypedDict):
    ...
    notes: Annotated[list[str] | None, operator.add] = None
    final_report: str = Annotated[str, "Final report Generated by Research Agents"]
    mcp_tools: list[Any] = Annotated[list, "Final report Generated by Research Agents"]
    mcp_tools_by_name: dict[str, Any] = Annotated[
        dict,
        "Final report Generated by Research Agents",
    ]
